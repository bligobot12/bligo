...
var init_config = __esm({
  "node_modules/@opennextjs/aws/dist/adapters/config/index.js"() {
    ...
    AppPathsManifestKeys = ["/_not-found", "/api/auth/me/route", "/api/posts/[postId]/replies/[replyId]/route", "/api/posts/[postId]/replies/route", "/api/profile/update-signals/route", "/api/profile/update/route", "/api/search/classify/route", "/api/search/run/route", "/api/settings/apikey/route", "/api/skills/chat/route", "/api/v1/match/route", "/api/v1/posts/route", "/api/v1/profile/route", "/api/v1/search/route", "/api/v1/searches/route", "/logout/route", "/about", "/connections", "/contact", "/forgot-password", "/history", "/login", "/home", "/messages/[userId]", "/notifications", "/messages", "/onboarding", "/", "/posts", "/profile/[userId]", "/profile", "/reset-password", "/search", "/settings/api", "/signup", "/settings", "/skills/add", "/skills", "/app/messages", "/app", "/app/posts", "/app/profile", "/app/bot"];
